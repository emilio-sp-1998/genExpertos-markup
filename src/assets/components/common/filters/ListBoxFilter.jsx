...
function ListBoxFilter({ listBoxOption, setListBoxOption, dataListBox, name, dissabled=false }) {
  return (
    <Listbox
      value={listBoxOption}
      onChange={setListBoxOption}
      ...
      {({ open }) => (
        <div className="flex flex-col">
          ...
          <div className="relative mt-2">
            <Listbox.Button className="relative cursor-default pl-3 pr-10 text-left text-gray-900 sm:text-xs sm:leading-6 w-64 h-12 border-2 focus:border-primarymarkup-200 rounded-lg">
            ...
            <Transition
              ...
              leaveTo="opacity-0"
            >
              <Listbox.Options className="absolute z-10 mt-1 max-h-60 w-64 overflow-auto rounded-md py-1 text-sm shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-xs bg-white">
